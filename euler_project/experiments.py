...
Runs the numerical experiments for sheet 2.3 and writes a timestamped
run directory with figures, a canonical answers.txt, and combined PDFs
(`all_plots.pdf` and `results.pdf`).
"""
